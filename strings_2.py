...
separator = "-"
# Your code here
iterable1 = separator.join(["Python", "is", "fun"])
print(iterable1)
...
string16 = "python"
# Your code here
string16 = string16.startswith("py")
print(string16)
